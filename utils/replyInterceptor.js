...
CommandInteraction.prototype.reply = function (options) {
  ...
  try {
    ...
    logger.error('[ReplyInterceptor] Error in reply override:', e);
  }
...
CommandInteraction.prototype.editReply = function (options) {
  ...
  try {
    ...
    logger.error('[ReplyInterceptor] Error in editReply override:', e);
  }
...
CommandInteraction.prototype.followUp = function (options) {
  ...
  try {
    ...
    logger.error('[ReplyInterceptor] Error in followUp override:', e);
  }
  return originalFollowUp.call(this, options);
};

logger.info('[ReplyInterceptor] Command Interaction reply formatting hook initialized.');
